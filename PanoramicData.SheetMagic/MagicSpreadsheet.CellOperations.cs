...
public partial class MagicSpreadsheet
{
	...
	private static object? GetSharedStringValue(SharedStringTablePart? stringTable, string? cellValueText)
	{
		if (stringTable == null || cellValueText == null)
		{
			return string.Empty;
	...
	private static object? ParseBooleanValue(string? cellValueText)
	...
	private static object? ParseNumberValue(string? cellValueText)
	{
	...
	private static object? ParseDouble(string? cellValueText, Cell cell)
	{
	...
	private static object? ParseFloat(string? cellValueText, Cell cell)
	{
		// Handle special Infinity values
	...
	private static object? ParseNullableBool(string? cellValueText)
	{
	...
	private static object? ParseBooleanValueTyped(string? cellValueText)
		=> cellValueText switch
		{
			"1" or "true" => true,
			"0" or "false" => false,
	...
	private static object? ParseNumberTyped(string? cellValueText)
	{
		if (cellValueText == null)
		{
	...
	private static object? ParseDateTyped(string? cellValueText)
	{
		if (cellValueText == null)
		{
